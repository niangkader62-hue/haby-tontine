...
-- ============================================================
-- FICHIER SOURCE : supabase_checklist_versements.sql + supabase_fix_collecteur_recursion.sql
-- + supabase_prets_demandes.sql + supabase_rattrapage_final.sql (versions finales et corrigees)
-- ============================================================
-- Ce bloc regroupe le role "collecteur", le suivi photo des versements/prets,
-- la demande de pret par un membre, et les codes de securite de remise a zero.
-- Version FINALE et corrigee des regles (fonction is_collecteur_of dediee,
-- pas de sous-requete directe sur la table membres -- l'ancienne version dans
-- supabase_checklist_versements.sql causait une boucle infinie, deja corrigee ici).
-- ============================================================
...
-- Fonction dediee (comme is_owner_of / is_membre_of) : verifie si la personne
-- connectee est collectrice designee pour cette tontine, SANS sous-requete
-- directe sur la table membres (evite la boucle infinie RLS).
...
-- Un membre peut demander un pret, mais UNIQUEMENT en son propre nom,
-- et UNIQUEMENT dans une tontine dont il fait vraiment partie.
drop policy if exists "prets_write" on prets;
...
-- ============================================================
-- FICHIER SOURCE : supabase_declarations_prets_votes.sql
-- ============================================================
...
-- ============================================================
-- FICHIER SOURCE : supabase_rollover_cycles.sql
-- ============================================================
-- PASSAGE AUTOMATIQUE AU CYCLE SUIVANT
-- Une tache planifiee quotidienne (Edge Function rollover-cycles, voir
-- supabase/functions/rollover-cycles/index.ts) fait passer une tontine au
-- cycle suivant 3 jours apres sa date d'echeance. Tout solde impaye devient
-- une dette cumulee par membre (jamais effacee automatiquement) ; versements
-- et paye repartent a zero pour le nouveau cycle.
-- ============================================================
